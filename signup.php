        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> 
                    <img style="width: 64px" src="images/iit-logo.png"alt="iiit logo"/>
                    <span class="iiitbookstore" style="font-family: 'Open Sans', sans-serif; font-weight:600; font-size: 21px;">IIT Guwahati</span>
                </a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="login.php">Student-Login <i class="fa fa-sign-in" style="color: blue" aria-hidden="true"></i> </a> </li>
            </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="login-content">
        ...
        <div class="lform">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <input class="btn btn-primary submit-button" type="submit" value="Sign Up">
                <p class="signupnow">Already have an account? <a href="login.php" style="color:green" >Login here</a>
